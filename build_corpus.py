...
WIKI_LINKS_PATH = os.path.join(DATA_DIR, "Wiki_links.txt")
TAXONOMY_DIR = os.path.join(DATA_DIR, "taxonomy")
OUTPUT_JSONL = os.path.join(DATA_DIR, "text_corpus.jsonl")
OUTPUT_TXT = os.path.join(DATA_DIR, "text_corpus.txt")
